  ...
  render() {
    ...
    return <View style={[styles.tabs, this.props.style,]}>
      ...
      <View style={{ position: 'absolute', top: -25, left: (width - 70) / 2, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff', width: 70, height: 70, borderRadius: 70, elevation: 3 }}>
        <TouchableOpacity
          onPress={() => { this.props.navigation.navigate('StudentsAddScreen') }}
          style={{ backgroundColor: '#FD3434', borderRadius: 55, width: 55, height: 55, borderWidth: 2, borderColor: '#fff', alignItems: 'center', justifyContent: 'center', }}>
